...
public class PasswordObject implements Serializable {
    ...
    public PasswordObject(String password, String platform) throws NullPointerException, EncryptionException {
        ...
        this.password = passwordEncryptor.encryptPassword(Objects.requireNonNull(password)).orElseThrow(EncryptionException::new);
    ...
    public Optional<String> getDecryptedPassword() {
        return passwordEncryptor.decryptPassword(password);
    }
